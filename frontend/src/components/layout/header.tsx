...
export function Header({ onMenuClick }: HeaderProps) {
  return (
    <header className="sticky top-0 z-40 flex h-14 items-center gap-4 border-b bg-background/80 px-4 backdrop-blur-xl lg:px-6">
      ...
      <div className="relative hidden flex-1 md:block md:max-w-sm">
        ...
        <Input
          ...
          className="h-9 bg-muted/50 pl-9 border-0 focus-visible:ring-1"
        />
