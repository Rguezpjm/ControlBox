...
import { wordpressApi, type WordPressSiteAccessInfo } from "@/lib/wordpress";
import { ApiError } from "@/lib/api-client";
import { toast } from "sonner";

interface WordPressSiteAccessPanelProps {
  siteId: string;
...
export function WordPressSiteAccessPanel({
  ...
  async function handleChangePassword() {
    ...
    setSaving(true);
    try {
      await wordpressApi.changeAdminPassword(siteId, newPassword);
      toast.success("Contraseña de administrador actualizada en WordPress");
      setNewPassword("");
      setConfirmPassword("");
      onUpdated?.();
    } catch (err) {
