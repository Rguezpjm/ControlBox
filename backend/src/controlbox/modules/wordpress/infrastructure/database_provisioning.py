"""Provision and persist MySQL databases for WordPress sites."""
...
async def provision_wordpress_managed_database(
    uow: UnitOfWork,
    settings: Settings,
    site: WordPressSite,
    ...
    if logical_user:
        ...
        short_user = slug.replace("wp_", "u")[:30] or "wpuser"
